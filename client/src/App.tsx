...
import { DemoCallWidget } from "@/components/landing/DemoCallWidget";
          ...
          <main className="flex-1 overflow-auto">
            <div className="w-full px-4 md:px-10 lg:px-16 xl:px-20 py-4 md:py-6">
              <Switch>
                ...
                <Route path="/app/transaction-history" component={TransactionHistory} />
                ...
                <Route path="/app/flows/templates" component={FlowTemplatesPage} />
