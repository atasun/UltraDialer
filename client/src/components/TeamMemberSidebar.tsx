...
const USER_SECTION_ROUTES: Record<string, { url: string; icon: any; label: string; group: string; iconColor?: string }[]> = {
  ...
  templates: [
    { url: "/app/flows/templates", icon: Layout, label: "Templates", group: "build", iconColor: "text-fuchsia-500" },
  ],
  contacts: [
  ...
  billing: [
    ...
    { url: "/app/transaction-history", icon: FileText, label: "Transaction History", group: "billing", iconColor: "text-slate-500" },
  ],
  api_keys: [
