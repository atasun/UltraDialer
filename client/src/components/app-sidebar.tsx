...
export function AppSidebar() {
  ...
  const buildItems = [
    ...
    { title: t('nav.promptTemplates'), url: "/app/prompt-templates", icon: FileText, hasPlus: true, iconColor: "text-green-500" },
    { title: t('nav.knowledgeBase'), url: "/app/knowledge-base", icon: BookOpen, iconColor: "text-violet-500" },
    { title: t('nav.voices'), url: "/app/voices", icon: Mic, hasPlus: true, iconColor: "text-pink-500" },
  ];
  ...
  const flowAutomationItems = [
    ...
    { title: t('nav.templates'), url: "/app/flows/templates", icon: Layout, iconColor: "text-fuchsia-500" },
  ];
  ...
  const getAllBillingItems = () => {
    return [
      ...
      { title: t('nav.transactionHistory'), url: "/app/transaction-history", icon: FileText, iconColor: "text-slate-500" },
    ];
  };
