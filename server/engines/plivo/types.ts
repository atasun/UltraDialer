...
export type OpenAIRealtimeModel = 'gpt-4o-realtime-preview' | 'gpt-4o-mini-realtime-preview';
...
export const MODEL_TIER_CONFIG: Record<ModelTier, { models: OpenAIRealtimeModel[]; description: string }> = {
  free: {
    ...
    description: 'GPT-4o Mini Realtime - Cost-effective, fast responses',
  },
  pro: {
    models: ['gpt-4o-realtime-preview', 'gpt-4o-mini-realtime-preview'],
    description: 'Full model access including GPT-4o Realtime',
  },
};
