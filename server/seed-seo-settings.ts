...
const SEO_SETTINGS_SEED_DATA = [
  ...
  {
    key: "seo_site_title",
    value: "AgentLabs - AI-Powered Bulk Calling Platform",
    description: "Default site title for SEO",
  },
  {
    key: "seo_site_description",
    value: "Automate your outbound communication with AI-powered voice agents. AgentLabs helps businesses scale their calling campaigns with intelligent automation, lead qualification, and real-time analytics.",
  ...
  {
    key: "seo_og_title",
    value: "AgentLabs - Scale Your Outreach with AI Voice Agents",
...
Sitemap: {{site_url}}/sitemap.xml`,
  ...
  // ============================================
  {
    ...
    value: {
      ...
      "@type": "Organization",
      "name": "AgentLabs",
      "description": "AI-Powered Bulk Calling Platform",
      "url": "{{site_url}}",
      "logo": "{{logo_url}}",
      "contactPoint": {
        "@type": "ContactPoint",
  ...
  {
    key: "seo_home_title",
    value: "AgentLabs - AI-Powered Bulk Calling Platform | Automate Your Outreach",
    description: "Homepage specific title",
  },
  {
    key: "seo_home_description",
    value: "Transform your outbound communication with AI voice agents. AgentLabs helps you automate calls, qualify leads, and scale your sales operations effortlessly.",
    description: "Homepage specific description",
  },
  {
    key: "seo_pricing_title",
    value: "Pricing - AgentLabs | Flexible Plans for Every Business",
  ...
  {
    key: "seo_login_title",
    value: "Sign In - AgentLabs",
    description: "Login page specific title",
  },
  {
    key: "seo_register_title",
    value: "Create Account - AgentLabs | Start Your Free Trial",
