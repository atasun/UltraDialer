...
export const agents = pgTable("agents", {
  ...
  // 'twilio-openai' = Twilio telephony + OpenAI Realtime API
  ...
  telephonyProvider: text("telephony_provider").default("twilio"), // 'twilio' | 'plivo' | 'twilio-openai' | 'elevenlabs-sip' | 'fonoster-openai'
  ...
  // OpenAI Realtime Configuration (used when telephonyProvider='plivo', 'twilio-openai', or 'fonoster-openai')
...
export const seoSettings = pgTable("seo_settings", {
  ...
  defaultTitle: text("default_title").default("AgentLabs - AI Calling Platform"),
...
export const plivoCalls = pgTable("plivo_calls", {
  ...
  openaiModel: text("openai_model").default("gpt-4o-mini-realtime-preview"),
...
export const twilioOpenaiCalls = pgTable("twilio_openai_calls", {
  ...
  openaiSessionId: text("openai_session_id"),
  openaiVoice: text("openai_voice").default("alloy"),
  openaiModel: text("openai_model").default("gpt-4o-realtime-preview"),
